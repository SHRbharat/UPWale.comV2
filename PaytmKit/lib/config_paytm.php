...
define('PAYTM_MERCHANT_KEY', '%NRFC&QW4gc3Ol@7'); //Change this constant's value with Merchant key received from Paytm.
define('PAYTM_MERCHANT_MID', 'bXXHUL40068323516700'); //Change this constant's value with MID (Merchant ID) received from Paytm.
...
if (PAYTM_ENVIRONMENT == 'PROD') {
	...
	//Change this constant's value with Merchant key received from Paytm.
	$PAYTM_MERCHANT_MID 		= "bXXHUL40068323516700";
	$PAYTM_MERCHANT_KEY 		= "%NRFC&QW4gc3Ol@7";
