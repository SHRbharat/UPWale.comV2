	...
	if( $_SESSION['username'] != "NULL" ){
        ...
        xmlhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
				...
				echo "<script> alert(this.responseText); </script>";
            }
        };
        //xmlhttp.open("GET", "gethint.php?q=" + str, true);
        xmlhttp.open("POST", "include/addToCart.php", true);
        xmlhttp.send();
	}else{
            ...
            <div class="row product-row">
                ...
                <div class="col-7 col-md-12">
                    <div class="product-info">
                        ...
                        <div>
                            <input name="add_to_cart" type="submit" value="add to cart" onclick="addToCart()" class="btn-flat btn-hover" ></a>
                        </div>
						</form>
                    </div>
                </div>
